 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "db.gateway.dynamicRoute", name = "enabled", havingValue = "true")
public class DynamicZuulRouteConfig {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "db.gateway.dynamicRoute", name = "dataType", havingValue = "nacos", matchIfMissing = true)
